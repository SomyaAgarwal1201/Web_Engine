...
long Solutions::Life_solution(string word_search, int push_key) {
    ...
    ifstream getFile("C:\\Users\\MY HP\\Desktop\\cpp\\Generic_Problem.txt");
...
void Solutions::subSearch(int sub_Search, int words, string searchedString) {
    ...
    if (sub_Search <= words && words > 0) {
        try {
            ...
            ifstream soln("C:\\Users\\MY HP\\Desktop\\cpp\\Generic_Solutions.txt");
            if (soln.is_open()) {
        ...
        out.open("C:\\Users\\MY HP\\Desktop\\cpp\\Generic_Problem.txt", std::ios::app);
